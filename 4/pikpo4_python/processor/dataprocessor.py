...
class DataProcessor(ABC):
    ...
    def run(self) -> None:
        ...
        # cleaned_result = self.remove_col_by_name(self._dataset, ['y1980', 'y1981'])
        ...
        #Удаляем колонки указанные в параметры  ниже
        cleaned_result = self.remove_col_by_name(self._dataset, ['y1963', 'y1964'])
        print(cleaned_result)
        #Отображаем только выбранные страны
        countries = ['Argentina', 'Ghana', 'Lesotho']
